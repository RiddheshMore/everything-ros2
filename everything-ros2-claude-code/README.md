...
```bash
# Add marketplace
/plugin marketplace add your-username/everything-ros2-claude-code

# Install
/plugin install everything-ros2-claude-code@everything-ros2-claude-code
```

### Manual Install

```bash
git clone https://github.com/your-username/everything-ros2-claude-code.git
...
# Copy rules (pick your language)
cp -r rules/common/* ~/.claude/rules/
cp -r rules/cpp/* ~/.claude/rules/       # for C++ ROS 2 nodes
cp -r rules/python/* ~/.claude/rules/    # for Python ROS 2 nodes
```
